...
export async function proposeSkillSwap(
  toUserId: number,
  offeredSkill: string,
...
export async function updateSkillSwapStatus(
  id: number,
...
export async function getSkillSwapMessages(
  id: number,
  token: string
): Promise<SkillSwapMessage[]> {
...
export async function postSkillSwapMessage(
  id: number,
  message: string,
  token: string
): Promise<SkillSwapMessage> {
...
export async function getSkillSwapHistory(
  id: number,
  token: string
): Promise<SkillSwapStatusHistory[]> {
